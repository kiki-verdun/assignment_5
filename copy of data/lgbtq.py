...
headers = ['source_file', 'item_id', 'title', 'date', 'source_url', 'phys_format', 'dig_format', 'rights','subject_headings']
...
# set up a list for the columns in your csv; in future, this should be more automated but this works for now as you set up the crosswalk
headers = ['item_id','title','call_number','contributors','date_extracted', 'notes', 'language' ,'source_file',  'date', 'source_url', 'phys_format', 'dig_format', 'rights', 'image_url','subject_headings' ]
